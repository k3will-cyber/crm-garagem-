module.exports = [
  ...
  // 💡 Iluminação
  { nome: 'Lâmpada Farol Alto', descricao: 'Lâmpada H4 farol alto/b axiom', preco: 15.00, categoria: 'iluminacao', quantidade: 30 },
  ...
  { nome: 'Bucha Suspensão', descricao: 'Bucha de suspensão', preco: 25.00, categoria: 'suspensao', quantidade: 25 },
  ...
  // 🧰 Diversos
  { nome: 'Limpador Para-brisa', descricao: 'Palheta limpador para-brisa 22"', preco: 22.90, categoria: 'diversos', quantidade: 25 },
  ...
  { nome: 'Adesivo Rodas Balanceamento', descricao: 'Kit adesivos de balanceamento', preco: 5.00, categoria: 'diversos', quantidade: 50 },
  { nome: 'Lona Protetora', descricao: 'Lona para proteção do veículo na oficina', preco: 29.90, categoria: 'diversos', quantidade: 10 },
